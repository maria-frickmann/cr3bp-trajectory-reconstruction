...
ax_zeit.set_title(r'$q_1$ über der Zeit bei $\alpha_{\min}^{\mathrm{BLR}}$' + '\n',
                   fontsize=fontsize)
...
save_diagram(fig_zeit, 'blr_trajektorienrekonstruktion_1d.pdf', unterordner = 'physik_rekonstruktion')
plt.show()